...
```mermaid
graph TB
  subgraph "Digital & Code"
    MS["Munus Shih<br/>Tools &<br/>Generative Systems"]
  end

  subgraph "Materiality & Print"
    AP["Asad Pervaiz<br/>Form &<br/>Constraints"]
  end

  subgraph "Research & Practice"
    CS["Carolina Stierli<br/>de Abreu<br/>Affordances &<br/>Experiments"]
  end

  MS -.->|bridge| Bridge["Hybrid Publishing<br/>Practice"]
  AP -.->|bridge| Bridge
  CS -.->|bridge| Bridge
```
